    ...
    Column(
        ...
        Card(
            ...
            Text(
                ...
                fontWeight = FontWeight.Bold,
                color = Color.Black,
                text = stringResource(id = R.string.statusPerkawinan),
            )
        ...
        ElevatedCard(
            ...
            )
            {
                ...
                Text(text = "Kelamin           : " + jenis, color = Color.White)
                Text(text = "Status Kawin  : " + statusPernikahan, color = Color.White)
